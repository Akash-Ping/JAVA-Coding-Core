...
public class StreamDemo {
    public static void main(String[] args) {
        ...
        Optional<Integer> max = list.stream().max(((o1, o2) -> o1.compareTo(o2)));  // using comparator i.e. defalt sorting order
        ...
        List<Student> collect2 = listOfStudents.stream()
                        .sorted(Comparator.comparing(Student::getName)).collect(Collectors.toList());

        List<Student> collect3 = listOfStudents.stream()
